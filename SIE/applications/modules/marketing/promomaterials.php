				...
				default:?>
					...
					<div class="box-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php
							$nourut=0;
							$query_sub=$query("select * from tbl_submissions where category='$_GET[l]' order by id DESC");
							...
							//end approve status
								?>
									<tr id="tr_table">
										...
										<td align="left"><a href="print-promomaterial.php?id=<?=$row_sub['id']?>" target="_blank">#<?=sprintf('%03d',$row_sub['id'])?></a><?=$correction?></td>
