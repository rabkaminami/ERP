			...
			switch($_GET['p']){
				...
				default:?>
					...
					if($_GET['action']=='approve'){
						$update=$query("update tbl_production_planning SET approve1='1',correction='',correction_by='0' where id='$_GET[id]'");
					}
					if($_GET['action']=='unapprove'){
						$update=$query("update tbl_production_planning SET approve1='0' where id='$_GET[id]'");
					}
					?>
					<div class="box-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							if(empty($row_pp['approve1'])){
								$approve1="<a href='?m=$_GET[m]&mm=$_GET[mm]&s=$_GET[s]&l=$_GET[l]&p=$_GET[p]&open=$_GET[open]&action=approve&id=$row_pp[id]'><img src='$template/dist/img/silang.png'></a>";	
							}
							else{
