			...
			switch($_GET['p']){
				...
				default:?>
					...
					if($_GET['action']=='approve'){
						$update=$query("update tbl_sp_header SET approve3='1',correction='',correction_by='0' where id='$_GET[id]'");
					}
					if($_GET['action']=='unapprove'){
						$update=$query("update tbl_sp_header SET approve3='0' where id='$_GET[id]'");
					}
					?>
					<div class="box-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							if(empty($row_sub['approve3'])){
								$approve3="<a href='?m=$_GET[m]&mm=$_GET[mm]&s=$_GET[s]&l=$_GET[l]&p=$_GET[p]&open=$_GET[open]&action=approve&id=$row_sub[id]'><img src='$template/dist/img/silang.png'></a>";	
							}
							else{
								$approve3="<a href='?m=$_GET[m]&mm=$_GET[mm]&s=$_GET[s]&l=$_GET[l]&p=$_GET[p]&open=$_GET[open]&action=unapprove&id=$row_sub[id]'><img src='$template/dist/img/ceklist.png'></a>";
							}
